...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="../assets/img/tooth.png" />
    <title>DESCIC - Login</title>
                ...
                <div class="row">
                    <div
                        ...
                        <div class="login-brand">
                            <img src="../assets/img/tooth.png" alt="logo" width="100"
                            ...
                            <div class="card-body">
                                <form method="POST" action="" class="needs-validation" novalidate="" autocomplete="off">
                                    <div class="form-group">
                                        ...
                                        <input id="username" type="text" class="form-control" minlength="2"
