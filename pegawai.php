                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-action">
                                            <a href="#" class="btn btn-primary" data-target="#addUser"
                                                data-toggle="modal">Tambah Pegawai</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php
																if ($row['pekerjaan'] == '1') {
																	...
																	echo '<div class="badge badge-pill badge-success mb-1">Admin';
																} ?>
                                        </div>
                                        </td>
                                        <td>
                                            ...
                                            <a class="btn btn-danger btn-action" data-toggle="tooltip" title="Hapus"
                                                ...
                                                data-confirm-yes="window.location.href = 'auth/delete.php?type=pegawai&id=<?php echo $row['id']; ?>'"
