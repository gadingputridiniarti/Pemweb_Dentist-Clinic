                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-action">
                                            <a href="#" class="btn btn-primary" data-target="#addObat"
                                                data-toggle="modal">Tambahkan Obat Baru</a>
                                            <a href="excel.php"> <button class="btn btn-primary">Cetak
                                                </button></a>
