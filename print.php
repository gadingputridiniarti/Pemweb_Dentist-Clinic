...
if (isset($_POST['printall'])) {
  $riwayatpenyakit = mysqli_query($conn, "SELECT * FROM data_pemeriksaan WHERE id_pasien='$idid' ORDER BY tgl ASC");
} elseif (isset($_POST['printone']) || isset($_POST['detail'])) {
  $idriwayat = $_POST['idriwayat'];
  $riwayatpenyakit = mysqli_query($conn, "SELECT * FROM data_pemeriksaan WHERE id_pasien='$idid' AND id='$idriwayat'");
  ...
  $penyakit = mysqli_query($conn, "SELECT * FROM data_pemeriksaan WHERE id_pasien='$idid' AND id='$idfoto'");
...
<div class="section-body">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Catatan Riwayat Periksa Pasien</h4>
                </div>
                <div class="card-body">
